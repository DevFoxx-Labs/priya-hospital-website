        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-500/20 text-emerald-300 text-xs font-extrabold border border-emerald-500/40">
            ...
            {/* Slogan */}
            <p className="text-base sm:text-lg font-bold text-amber-400 tracking-wide italic">
